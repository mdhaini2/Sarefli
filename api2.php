...
$Amount = floatval($_POST["Amount"]); //getting those data from the application
...
date_default_timezone_set('Asia/Beirut'); //getting date and time for each conversion
...
echo json_encode($Result); //returning the result to the application as JSON
?>