<?php 
    include("simple_html_dom.php"); //library to get built in functions that we used to get content from website 
            ...
            if($html= file_get_contents("https://lirarate.org/wp-json/lirarate/v2/rates?currency=LBP&_ver=t20223290")){//getting the content from api rate that lirarate.org use 
